if __name__ == '__main__':
    ...
    li_NameRemove = ['Acquisition Comments',
    ...
    li_NameReplace = ['Accession Number',
                           'Acquisition Date',
    ...
    iName = 0
    for elem in li_NameUID:
        found = False
        for officialElem in DicomDictionary:
            if elem in DicomDictionary[officialElem]:
                iName += 1
                found = True
                break
        for officialElem in RepeatersDictionary:
            if elem in RepeatersDictionary[officialElem]:
                iName += 1
                found = True
                break
    ...
    print "regenerate uid: " + str(iName) + " from " + str(len(li_NameUID))

    iName = 0
    for elem in li_NameRemove:
        found = False
        for officialElem in DicomDictionary:
            if elem in DicomDictionary[officialElem]:
                iName += 1
    ...
    print "remove: " + str(iName) + " from " + str(len(li_NameRemove))

    iName = 0
    for elem in li_NameReplace:
        found = False
        for officialElem in DicomDictionary:
            if elem in DicomDictionary[officialElem]:
                iName += 1
    ...
    print "replace: " + str(iName) + " from " + str(len(li_NameReplace))